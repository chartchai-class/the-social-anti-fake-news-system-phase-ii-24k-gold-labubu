...
//                .time("12:00")
//                .petAllowed(true)
//                // .organizer("Kat Laydee")  // Commented out - organizer is now Organizer type, not String
//                .build());
//        eventList.add(Event.builder()
//                .id(456L)
//                .category("food")
...
//                .time("10:00")
//                .petAllowed(true)
//                // .organizer("Fern Pollin")  // Commented out
//                .build());
//        eventList.add(Event.builder()
//                .id(789L)
...
//                .time("11:00")
//                .petAllowed(false)
//                // .organizer("Carey Wales")  // Commented out
//                .build());
//        eventList.add(Event.builder()
//                .id(1001L)
//                .category("animal welfare")
...
//                .time("12:00")
//                .petAllowed(true)
//                // .organizer("Dawg Dahd")  // Commented out
//                .build());
//        eventList.add(Event.builder()
//                .id(1002L)
//                .category("food")
...
//                .time("3:00")
//                .petAllowed(true)
//                // .organizer("Kahn Opiner")  // Commented out
//                .build());
//        eventList.add(Event.builder()
//                .id(1003L)
//                .category("sustainability")
...
//                .time("11:00")
//                .petAllowed(false)
//                // .organizer("Brody Kill")  // Commented out
//                .build());
//    }
//
//    @Override
